...
export default class hclListener extends antlr4.tree.ParseTreeListener {
	...
	enterDataDirective(ctx) {
		data_directive.enter_data_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitDataDirective(ctx) {
		data_directive.exit_data_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterModuleDirective(ctx) {
		module_directive.enter_module_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitModuleDirective(ctx) {
		module_directive.exit_module_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitModuleSource(ctx) {
		module_source.exit_module_source({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterProviderDirective(ctx) {
		provider_directive.enter_provider_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitProviderDirective(ctx) {
		provider_directive.exit_provider_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterTerraformDirective(ctx) {
		terraform_directive.enter_terraform_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitTerraformDirective(ctx) {
		terraform_directive.exit_terraform_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterResourceDirective(ctx) {
		resource_directive.enter_resource_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitResourceDirective(ctx) {
		resource_directive.exit_resource_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterVariableDirective(ctx) {
		variable_directive.enter_variable_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitVariableDirective(ctx) {
		variable_directive.exit_variable_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterOutputDirective(ctx) {
		output_directive.enter_output_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitOutputDirective(ctx) {
		output_directive.exit_output_directive({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitProviderType(ctx) {
		provider_type.exit_provider_type({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	enterComplexField(ctx) {
		complex_field.enter_complex_field({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
	...
	exitComplexField(ctx) {
		complex_field.exit_complex_field({
			ctx: { ctx, errors: this.prog.errors },
			prog: this.prog,
		});
	}
